---
name: simplify
description: Review all changed code for reuse, quality, and efficiency using 3 parallel specialist agents, then fix every issue found.
...
2. **Parameter sprawl**: adding new parameters to a function instead of generalizing existing ones
...
4. **Recurring no-op updates**: state/store updates inside polling loops that fire unconditionally without change-detection
