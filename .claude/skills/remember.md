---
name: remember
description: Review auto-memory entries and propose promotions to CLAUDE.md or CLAUDE.local.md — also detects outdated, conflicting, and duplicate entries across memory layers
